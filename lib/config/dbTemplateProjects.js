...
var addTemplateForCpp14 = function() {
        ...
        .find({
          ...
          if(result === null) {
            ...
            db.TemplateProject.create({
              ...
              var _content = fs.readFileSync('db_templates/C++14/Root/codeboard.json', 'utf8');
              ...
              var _content = fs.readFileSync('db_templates/C++14/Root/main.cpp', 'utf8');
...
var addTemplateForEiffel = function() {

  return new Promise(function (resolve, reject) {
    db.TemplateProject
      .find({
        where: {language: 'Eiffel'}
      }).then(function(result) {
        ...
        if(result === null) {
          ...
          db.TemplateProject.create({
            ...
            //console.log('Current working directory: ' + process.cwd());
            // reads the file relative the process.cwd() (that's where server.js lives)
            var _content = fs.readFileSync('db_templates/Eiffel/Root/project.ecf', 'utf8');
            ...
            //console.log('Current working directory: ' + process.cwd());
            // reads the file relative the process.cwd() (that's where server.js lives)
            var _content = fs.readFileSync('db_templates/Eiffel/Root/application.e', 'utf8');
...
var addTemplateForEiffelSCOOP = function() {

  return new Promise(function (resolve, reject) {
    db.TemplateProject
      .find({
        where: {language: 'Eiffel-SCOOP'}
      }).then(function(result) {
        ...
        if(result === null) {
          ...
          db.TemplateProject.create({
            ...
            //console.log('Current working directory: ' + process.cwd());
            // reads the file relative the process.cwd() (that's where server.js lives)
            var _content = fs.readFileSync('db_templates/Eiffel-SCOOP/Root/project.ecf', 'utf8');
            ...
            //console.log('Current working directory: ' + process.cwd());
            // reads the file relative the process.cwd() (that's where server.js lives)
            var _content = fs.readFileSync('db_templates/Eiffel-SCOOP/Root/application.e', 'utf8');
...
var addTemplateForInferJava = function() {

  return new Promise(function (resolve, reject) {
    db.TemplateProject
      .find({
        where: {language: 'Infer-Java'}
      }).then(function(result) {
        ...
        if(result === null) {
          ...
          db.TemplateProject.create({
            ...
            //console.log('Current working directory: ' + process.cwd());
            // reads the file relative the process.cwd() (that's where server.js lives)
            var _content = fs.readFileSync('db_templates/Infer-Java/Root/codeboard.json', 'utf8');
            ...
            //console.log('Current working directory: ' + process.cwd());
            // reads the file relative the process.cwd() (that's where server.js lives)
            var _content = fs.readFileSync('db_templates/Infer-Java/Root/Hello.java', 'utf8');
...
var addTemplateForReason = function() {

  return new Promise(function (resolve, reject) {
    db.TemplateProject
      .find({
        where: {language: 'Reason'}
      }).then(function(result) {
        ...
        if(result === null) {
          ...
          db.TemplateProject.create({
            ...
            var _content = fs.readFileSync('db_templates/Reason/Root/codeboard.json', 'utf8');
            ...
            var _content = fs.readFileSync('db_templates/Reason/Root/Hello.re', 'utf8');
            ...
            var _content = fs.readFileSync('db_templates/Reason/Root/Message.re', 'utf8');
...
var addTemplateForPython3 = function() {
        ...
        .find({
          ...
          if(result === null) {
            ...
            db.TemplateProject.create({
              ...
              // console.log('Current working directory: ' + process.cwd());
              // reads the file relative the process.cwd() (that's where server.js lives)
              var _content = fs.readFileSync('db_templates/Python3/Root/codeboard.json', 'utf8');
              ...
              // console.log('Current working directory: ' + process.cwd());
              // reads the file relative the process.cwd() (that's where server.js lives)
              var _content = fs.readFileSync('db_templates/Python3/Root/main.py', 'utf8');
